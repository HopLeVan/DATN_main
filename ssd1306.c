...
void ssd1306_clear_line(uint8_t line) {
    ssd1306_display_string(16, line, "                       "); // Giả sử mỗi dòng có 16 ký tự trống
}
...
void ssd1306_display_off() {
    ssd1306_command(0xAE); // Lệnh Display OFF
}

// Bật màn hình
void ssd1306_display_on() {
    ssd1306_command(0xAF); // Lệnh Display ON
}